...
test('Timeline: compare works with default sort', function () {
    $t = new Timeline();
    $t->insert(1, \Carbon\Carbon::now()->addHour());
    $t->insert(2, \Carbon\Carbon::now());
    $t->insert(3, \Carbon\Carbon::now()->subHour());
...
test('Timeline: compare works with oldest first', function () {
    $t = new Timeline();
    $t->oldestFirst();
    $t->insert(1, \Carbon\Carbon::now()->subHour());
    $t->insert(2, \Carbon\Carbon::now());
    $t->insert(3, \Carbon\Carbon::now()->addHour());
